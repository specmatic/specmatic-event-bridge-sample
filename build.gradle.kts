...
dependencies {
    ...
    implementation("aws.sdk.kotlin:eventbridge:1.9.4")
    implementation("aws.sdk.kotlin:sqs:1.9.9")
    implementation("aws.smithy.kotlin:http-client-engine-okhttp:1.7.11")
