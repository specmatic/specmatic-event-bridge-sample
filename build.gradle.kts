...
dependencies {
    ...
    implementation("aws.sdk.kotlin:eventbridge:1.8.31")
    implementation("aws.sdk.kotlin:sqs:1.8.31")
    implementation("aws.smithy.kotlin:http-client-engine-okhttp:1.7.7")
