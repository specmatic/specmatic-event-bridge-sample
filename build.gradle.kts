...
dependencies {
    ...
    implementation("aws.sdk.kotlin:eventbridge:1.6.102")
    implementation("aws.sdk.kotlin:sqs:1.6.102")
    implementation("aws.smithy.kotlin:http-client-engine-okhttp:1.6.15")
